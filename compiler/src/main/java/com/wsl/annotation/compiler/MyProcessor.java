...
public class MyProcessor extends AbstractProcessor {
    ...
    private static class CodeGenerator {
        ...
        public static TypeSpec generateClass(List<AnnotatedClass> classes) {
            TypeSpec.Builder builder = classBuilder(CLASS_NAME).addModifiers(Modifier.PUBLIC, Modifier.FINAL);
        ...
        private static MethodSpec makeCreateStringMethod(AnnotatedClass annotatedClass) {
            ...
            builder.append("\"}\"");
            return methodBuilder("createString").addJavadoc("@return string suitable for {@param instance}'s toString()").addModifiers(Modifier.PUBLIC, Modifier.STATIC).addParameter(TypeName.get(annotatedClass.getType()), "instance").addStatement(builder.toString()).returns(String.class).build();
        }
    }
